...
def draw_menu(window):
    ...
    background_image = pygame.image.load("./images/Desktop_Level 2.png")
                ...
                if event.button == 1:
                    ...
                    if 338 <= mouse_pos[1] <= 412:
                        if 198 <= mouse_pos[0] <= 376:
                            ...
                            print("A*!")
                            subprocess.Popen(["python","./source/chooseMap.py", "./source/A.py"])
                            pygame.quit()  # Thoát khỏi cửa sổ hiện tại
                            sys.exit()
                        ...
                        if 198 <= mouse_pos[0] <= 376:
                            print("UCS!")
                            subprocess.Popen(["python", "./source/chooseMap.py","./source/UCS.py"])
                            pygame.quit()  # Thoát khỏi cửa sổ hiện tại
                            sys.exit()
                        elif 647 <= mouse_pos[0] <= 823:
